...
import Relatorios.DanfeNFCe_Contigencia;
...
import static gerenciador.AcoesNFCe.EnvioNFCe.itens;
import static gerenciador.AcoesNFCe.EnvioNFCe.nota;
import static gerenciador.AcoesNFCe.EnvioNFCe.venda;
...
public class EnvioNFCeContigencia {
    ...
    public static void Envia() {
        ...
        try {
           ...
           ConfiguracoesNfe config = configuraçãoNFCE;//IniciaConfiguraçãoNFCE.iniciaConfigurações();
            ...
            ide.setXJust("Falta de comunicação com a Sefaz");//Justificativa da entrada em contingência
            ...
            i++;
                    ...
                    }else{prod.setXProd(p.getDescrição()); //Descrição do produto ou serviço
                    }
            ...
            icmstot.setVICMS(decimalFormat.format(ic.doubleValue()).replaceAll(",", "."));//Valor Total do ICMS
                BigDecimal Deson = new BigDecimal(icmsDtot).setScale(2, RoundingMode.HALF_EVEN);
                if(icmsDtot<=0){icmstot.setVICMSDeson("0.00");}else{
            icmstot.setVICMSDeson(decimalFormat.format(Deson.doubleValue()).replaceAll(",", "."));//Valor Total do ICMS desonerado
                }
            ...
            Pag.DetPag detPag2 = new Pag.DetPag();
                ...
                if(venda.getModoPagamento1().equals("Dinheiro")){
                    ...
                    detPag.setVPag(String.valueOf(decimalFormat.format(aa.doubleValue())).replaceAll(",", "."));//Valor do Pagamento
            ...
            //QRCODE
            String qrCodeContigencia = NFCeUtil.getCodeQRCodeContingencia(
            ...
            SalvarXMLErro(qrCodeContigencia);
            ...
            //TramiteNota.Info.setText("Erro ao enviar Nota Fiscal: "+e.getMessage());
            //a.setVisible(false);
        }
     ...
     public static void SalvarXML(String Qr,String Conteudo){
        ...
        Tela_Caixa.Tramite(2);
            ...
            String urlDir = "C:\\Users\\Marcos\\Desktop\\Notas Fiscais\\XML_Conti";
            String urlxml = "C:\\Users\\Marcos\\Desktop\\Notas Fiscais\\XML_Conti\\"+Nota+".xml";
     ...
     public static void SalvarXMLErro(String Qr){
        ...
        //TramiteNota.Info.setText("Salvando Nota...Aguarde");
        Tela_Caixa.Tramite(2);
        String Conteudo = "<enviNFe xmlns=\"http://www.portalfiscal.inf.br/nfe\" versao=\"4.00\"><idLote>0</idLote><indSinc>1</indSinc><NFe xmlns=\"http://www.portalfiscal.inf.br/nfe\"><infNFe versao=\"4.00\" Id=\"NFe29181011951317000120650010000000581633262341\"><ide><cUF>29</cUF><cNF>63326234</cNF><natOp>Venda</natOp><mod>65</mod><serie>1</serie><nNF>58</nNF><dhEmi>2018-10-15T01:32:10-03:00</dhEmi><tpNF>1</tpNF><idDest>1</idDest><cMunFG>2928703</cMunFG><tpImp>4</tpImp><tpEmis>1</tpEmis><cDV>1</cDV><tpAmb>2</tpAmb><finNFe>1</finNFe><indFinal>1</indFinal><indPres>1</indPres><procEmi>0</procEmi><verProc>eGDV 1.0</verProc></ide><emit><CNPJ>11951317000120</CNPJ><xNome>G D S SUPERMERCADO LTDA - ME</xNome><xFant>SUPERMERCADO GERMAN</xFant><enderEmit><xLgr>Cosme e Damiao</xLgr><nro>440</nro><xCpl>Casa</xCpl><xBairro>Andaia</xBairro><cMun>2928703</cMun><xMun>Santo Antonio de Jesus</xMun><UF>BA</UF><CEP>44572420</CEP><cPais>1058</cPais><xPais>BRASIL</xPais><fone>75988047867</fone></enderEmit><IE>087790081</IE><CRT>1</CRT></emit><det nItem=\"1\"><prod><cProd>7891164027339</cProd><cEAN>7891164027339</cEAN><xProd>NOTA FISCAL EMITIDA EM AMBIENTE DE HOMOLOGACAO - SEM VALOR FISCAL</xProd><NCM>04015010</NCM><CEST>1701700</CEST><indEscala>S</indEscala><CFOP>5102</CFOP><uCom>UN</uCom><qCom>1.0</qCom><vUnCom>4.59</vUnCom><vProd>4.59</vProd><cEANTrib>7891164027339</cEANTrib><uTrib>UN</uTrib><qTrib>1.0</qTrib><vUnTrib>4.59</vUnTrib><indTot>1</indTot></prod><imposto><vTotTrib>1.17</vTotTrib><ICMS><ICMSSN102><orig>0</orig><CSOSN>102</CSOSN></ICMSSN102></ICMS><PIS><PISNT><CST>04</CST></PISNT></PIS><COFINS><COFINSNT><CST>04</CST></COFINSNT></COFINS></imposto></det><total><ICMSTot><vBC>2.99</vBC><vICMS>0.54</vICMS><vICMSDeson>0.00</vICMSDeson><vFCP>0.00</vFCP><vBCST>0.00</vBCST><vST>0.00</vST><vFCPST>0.00</vFCPST><vFCPSTRet>0.00</vFCPSTRet><vProd>4.59</vProd><vFrete>0.00</vFrete><vSeg>0.00</vSeg><vDesc>0.00</vDesc><vII>0.00</vII><vIPI>0.00</vIPI><vIPIDevol>0.00</vIPIDevol><vPIS>0.00</vPIS><vCOFINS>0.00</vCOFINS><vOutro>0.00</vOutro><vNF>4.59</vNF><vTotTrib>1.17</vTotTrib></ICMSTot></total><transp><modFrete>9</modFrete></transp><pag><detPag><indPag>0</indPag><tPag>01</tPag><vPag>10.00</vPag></detPag></pag><infAdic><infCpl>Envio de NFCe</infCpl></infAdic></infNFe><infNFeSupl><qrCode><![CDATA[http://hnfe.sefaz.ba.gov.br/servicos/nfce/modulos/geral/NFCEC_consulta_chave_acesso.aspx?p=29181011951317000120650010000000581633262341|2|2|1234567890|6340E821319113DECF76936445A68540411709C9]]></qrCode><urlChave>http://hinternet.sefaz.ba.gov.br/nfce/consulta</urlChave></infNFeSupl><Signature xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod Algorithm=\"http://www.w3.org/TR/2001/REC-xml-c14n-20010315\"/><SignatureMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference URI=\"#NFe29181011951317000120650010000000581633262341\"><Transforms><Transform Algorithm=\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\"/><Transform Algorithm=\"http://www.w3.org/TR/2001/REC-xml-c14n-20010315\"/></Transforms><DigestMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>/6AgS8QA/dnpLewpTh/q6VNIwpU=</DigestValue></Reference></SignedInfo><SignatureValue></SignatureValue><KeyInfo><X509Data><X509Certificate></X509Certificate></X509Data></KeyInfo></Signature></NFe></enviNFe>";
            DanfeNFCe_Contigencia c = new DanfeNFCe_Contigencia();
            //Salvar XML na pasta urlxml
   ...
   public static TNFe.InfNFe.Det.Imposto.ICMS.ICMS90 getICMS90(Produto p){
    ...
    public static ICMSSN900 getICMSSN900(Produto p){
        ...
        icmssn900.setVBC(p.getBaseICMS());//Valor da BC do ICMS

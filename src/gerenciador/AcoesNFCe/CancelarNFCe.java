...
public class CancelarNFCe {
    ...
    public static void recebe() {
        ...
        try {
            ...
            TRetEnvEvento retorno = Nfe.cancelarNfe(enviEvento, false, ConstantesUtil.NFCE);

            if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
                NotasFiscais.jTextArea6.setText("Status:" + retorno.getCStat() + " - Motivo:" + retorno.getXMotivo());
            ...
            if (!StatusEnum.EVENTO_VINCULADO.getCodigo().equals(retorno.getRetEvento().get(0).getInfEvento().getCStat())) {
                NotasFiscais.jTextArea6.setText("Status:" + retorno.getRetEvento().get(0).getInfEvento().getCStat() + " - Motivo:"
            ...
            NotasFiscais.jTextArea6.setText("Status:" + retorno.getRetEvento().get(0).getInfEvento().getCStat()+"\n"
            ...
            NotasFiscais.jTextArea6.insert("\n"+XmlUtil.objectToXml(procEvento), NotasFiscais.jTextArea6.getCaretPosition());
